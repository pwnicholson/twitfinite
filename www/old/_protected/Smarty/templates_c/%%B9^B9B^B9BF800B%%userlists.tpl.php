<?php /* Smarty version 2.6.18, created on 2010-09-19 17:52:14
         compiled from main/bot/userlists.tpl */ ?>
...
<?php if ($this->_tpl_vars['bot_settings']['retweet_restrictions'] == 'i'): ?>
...
<?php if ($this->_tpl_vars['bot_settings']['badwords_filter'] != ''): ?>
<div class="span-19 last"><br/></div>
<div class="span-19 last"><br/></div>


<div class="span-19 last"><h2>Bad Words Filter</h2></div>
<div class="span-19 last i">If you have bad word filtering enabled, this is where you can add words to filter.<br/><a href="<?php echo $this->_tpl_vars['root']; ?>
ajax/bot/badwords_default" target="badwords">View our default list.</a></div>
<script language="javascript">
<?php echo '
